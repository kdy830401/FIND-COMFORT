...
<body>
	...
	<div class="container">
	<form action="notice.res" method="post">  
	...
	<input type="title" class="form-control" name ="title" id="title" value='<%=request.getAttribute("title")%>' "placeholder=" ">
	</div>
	...
	<br>
	<h5><strong><%= loginAdmin.getAdminNo()%></strong></h5>
	</div>
	</div>
	...
	<input type="button" id="updateNoBtn" onclick = "location.href='notice.de'" id="cancelBtn" value="취소">
	</div>
