...
<div class="panel-heading"><h2 class="text-center">NOTICE</h2>
<p class="text-center">게시판 작성하기</p></div>
<div class="panel-body"> <!-- 패널 사용 -->

<div class="container">
<form action="notice.wrs" method="post">  
...
<input type="button" id="updateNoBtn" onclick = "location.href='notice.li'" id="cancelBtn" value="취소">
</div>
