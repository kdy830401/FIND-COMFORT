...
<textarea class="form-control" rows="10" name="content" id="content" required style="resize:none;"></textarea>
...
<input type="button" id="updateNoBtn" onclick = "location.href='<%= request.getContextPath() %>/qna.li'" id="cancelBtn" value="취소">
</div>
